            ...
            <div class="user-list">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <%
                            JDBC db = new JDBC();
                            ResultSet rs = db.getDataAll("SELECT * FROM pembelian WHERE status='pending'");
                            if (rs != null) {
                                while (rs.next()) {
                        %>
                        <tr>
                        ...
                        <td><a href="AdminController?action=VerifikasiPembayaran&id=<%= rs.getString("id_pembelian")%>" 
                               onclick="return confirm('Konfirmasi Pembayaran ini?')"
                               title="Verifikasi Pembayaran">
                                <i class="fa-solid fa-square-check" title="Verifikasi"></i>
                            </a></td>
                        <td><a href="AdminController?action=TolakPembayaran&id=<%= rs.getString("id_pembelian")%>" 
                               onclick="return confirm('Tolak Pembayaran ini?')"
                               title="Tolak Pembayaran">
                                <i class="fa-solid fa-trash delete-icon" title ="Tolak"></i>
                            </a></td>
                        </tr>
                        <%
                                }
